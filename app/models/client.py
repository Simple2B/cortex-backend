...
class Client(Base, ModelMixin):
    ...
    covid_tested_positive = Column(String, default=None)
    covid_vaccine = Column(String, default=None)
    ...
    def client_info(self):
        ...
        return {
            ...
            "covidTestedPositive": self.covid_tested_positive.value,
            "covidVaccine": self.covid_vaccine.value,
